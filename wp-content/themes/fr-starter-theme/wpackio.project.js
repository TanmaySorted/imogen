...
module.exports = {
	// Project Identity
	appName: 'frStarterTheme', // Unique name of your project
	type: 'theme', // Plugin or theme
	slug: 'fr-starter-theme', // Plugin or Theme slug, basically the directory name under `wp-content/<themes|plugins>`
	...
	files: [
		...
		// If has more length, then multi-compiler
		{
			...
			entry: {
				...
				editor: ['./resources/scripts/editor.js']
			},

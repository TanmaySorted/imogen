<?php
    ...
    function LoadAllFilesFromDir($dir) {
        $arr = [];
...
return [
    ...
    */
    ...
    'post' => LoadAllFilesFromDir('app/PostTypes/'),
    ...
    */
    ...
    'taxonomy' => LoadAllFilesFromDir('app/Taxonomies/'),
    ...
    */
    ...
    'block_pattern' => LoadAllFilesFromDir('app/BlockPatterns/'),
